...
public:
  ...
  const Frame &text(const char *const fmt, Args... args) const {
    ImGui::Text(fmt, args...);
    return *this;
  }
  ...
  bool inputScalar(const char *const label, ImGuiDataType data_type, void *data,
                   const void *step = nullptr, const void *step_fast = nullptr,
